...
[![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen)](https://carljmosca.github.io/caaf-mvp/)
...
**Granite: PWA Examples**

![Granite 4.0 Micro - Current Time Tool](images/Granite4.0Micro_PWA.png)
...
## 🏃‍♂️ Running the Application
 ...
 3.  **Using Tools**: The application connects to the internal WASM MCP server. You can ask questions that require tools, such as "What time is it?" or "Add 5 and 10".
 4.  **New Chat**: Click the "New Chat" button in the sidebar to reset the conversation context.
 
 ## 🔧 Configuration
 
 **Note:** The application uses an internal WASM MCP server. No external server configuration is required.
